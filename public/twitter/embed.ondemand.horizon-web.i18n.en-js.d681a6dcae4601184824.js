  ...
  [5762],
  {
    24349: (e, t, n) => {
      ...
      r('ed617674', '360'),
        ...
        r('f59bdb94', 'Provides details about protected accounts.'),
        r('d7e50a66', 'Learn more'),
        r('fc065ee4', 'Learn more about Subscriptions'),
        r('e453f536', 'What’s Subscriptions'),
        r(
          'dea63fc4',
        ...
        r('g57b5f6c', 'Your Subscriber'),
        r('a77a27c0', 'Subscribed'),
        ...
        r('h519ae04', 'The media has been disabled due to a copyright claim.'),
        ...
        r('e0f1a6df', function (e) {
          return (
            'People subscribed to or mentioned by @' +
            e.screenName +
            ' can reply'
          );
        }),
        ...
        r('bd414b44', 'Exclusive to your Subscribers'),
        r('aabc5339', function (e) {
          return (
            '@' + e.screenName + ' and their Subscribers can see your Tweet'
          );
        }),
        r('g1c6a77e', 'You’re seeing Subscriptions content'),
        r('d3b143d7', function (e) {
          return (
            'You can see this and reply because you’re Subscribed to @' +
            e.screenName
          );
        }),
        r('b756eaeb', function (e) {
          return (
            'You can see this Tweet because you’re Subscribed to @' +
            e.screenName
          );
        }),
        ...
        r('a0953370', 'Subscription'),
        r('ffb3fe6f', 'Keep reading'),
        r(
          'h18b719a',
          'This is a published Article, a new way to write on Twitter.'
        ),
        r('a44aa6d3', 'Keep reading'),
        ...
        r('b919a9ff', function (e) {
          return (
            e.standardTweetCount +
            ' character' +
            o(e.standardTweetCount, '', 's') +
        ...
        r('a385da25', function (e) {
          return (
            e.count + ' View' + o(e.count, '', 's') + '. View Tweet analytics'
          );
        }),
        r('j377cdca', 'Remove Tweet from Bookmarks'),
        r('d636ebc6', 'Like'),
        r('eb3a8b0c', 'Unlike'),
        ...
        r('a9980948', function (e) {
          return '' + e.formattedCount;
        }),
        r('ce44a35c', function (e) {
          return 'Subscriber' + o(e.count, '', 's');
        }),
        r('id949f68', function (e) {
          return '' + e.formattedCount;
        }),
        r('hb608cfc', function (e) {
        ...
        r('cd734f66', 'Today'),
        r('c8891d06', 'Tomorrow'),
        r('d2414d31', function (e) {
          return e.count + ' unread items';
        }),
        r('fb9f6f39', function (e) {
          return e.count + '+';
        }),
      ...
      })(n(74387)._ActualI18NFormatMessage || c.Component);
      ...
      n(17338),
        ...
        n(89518),
        n(93489),
        l._validateParameterTypeNumber,
        l._validateParameterPresence;
      var b = l._numberRound,
        m = (l._numberFormat, l._numberFormatterFn),
        h = l._pluralGeneratorFn,
        p =
    ...
    89518: function (e, t, n) {
      var r, o, a;
      !(function (i, c) {
        'use strict';
        (o = [n(51989), n(17338), n(16698)]),
          void 0 ===
            (a =
              'function' ==
              typeof (r = function (e) {
                var t = e._formatMessage,
                  ...
                  o = e._validateParameterTypeNumber;
                return (
                  (e._relativeTimeFormatterFn = function (e, n, a) {
                    return function (i) {
                      return (
                        r(i, 'value'),
                        o(i, 'value'),
                        (function (e, n, r, o) {
                          var a = o['relative-type-' + e];
                          return (
                            a ||
                            ((a = (
                              e <= 0
                                ? o['relativeTime-type-past']
                                : o['relativeTime-type-future']
                            )[
                  ...
                  (e.formatRelativeTime = e.prototype.formatRelativeTime =
                    function (e, t, n) {
                      return (
                        r(e, 'value'),
                        o(e, 'value'),
                        this.relativeTimeFormatter(t, n)(e)
                      );
                    }),
                  (e.relativeTimeFormatter = e.prototype.relativeTimeFormatter =
                    function (t, r) {
                      return (
                        (r = r || {}),
                        e[n('relativeTimeFormatter', this._locale, [t, r])]
                      );
                    }),
                  e
                );
            ...
            (a =
              ...
              typeof (r = function (e) {
                var t = e._formatMessage,
                  ...
                  o = e._validateParameterTypeNumber;
                return (
                  (e._unitFormatterFn = function (e, n, a) {
                    return function (i) {
                      return (
                        r(i, 'value'),
                        o(i, 'value'),
                  ...
                  (e.unitFormatter = e.prototype.unitFormatter =
                    function (t, r) {
                      return (
                        (r = r || {}),
                        e[n('unitFormatter', this._locale, [t, r])]
                      );
                    }),
                  e
                );
