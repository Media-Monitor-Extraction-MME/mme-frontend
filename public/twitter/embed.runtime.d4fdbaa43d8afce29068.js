(() => {
  ...
  (b.m = i),
    ...
    (b.O = (n, d, a, o) => {
      if (!d) {
        ...
        for (t = 0; t < e.length; t++) {
          for (var [d, a, o] = e[t], r = !0, c = 0; c < d.length; c++)
            (!1 & o || i >= o) && Object.keys(b.O).every((e) => b.O[e](d[c]))
              ? d.splice(c--, 1)
              : ((r = !1), o < i && (i = o));
          if (r) {
            e.splice(t--, 1);
    ...
    (b.t = function (e, a) {
      ...
      var i = {};
      n = n || [null, d({}), d([]), d(d)];
      for (var r = 2 & a && e; 'object' == typeof r && !~n.indexOf(r); r = d(r))
        Object.getOwnPropertyNames(r).forEach((n) => (i[n] = () => e[n]));
    ...
    (b.d = (e, n) => {
      for (var d in n)
        b.o(n, d) &&
          !b.o(e, d) &&
          Object.defineProperty(e, d, { enumerable: !0, get: n[d] });
    }),
    (b.f = {}),
    (b.e = (e) =>
      Promise.all(Object.keys(b.f).reduce((n, d) => (b.f[d](e, n), n), []))),
    (b.u = (e) =>
      'embed.' +
      ({
    ...
    (b.l = (e, n, d, i) => {
      if (a[e]) a[e].push(n);
        ...
        if (void 0 !== d)
          for (
            ...
            if (
              ...
              s.getAttribute('data-webpack') == o + d
            ) {
              r = s;
              break;
            }
        ...
        r ||
          ...
          r.setAttribute('data-webpack', o + d),
          (r.src = e)),
          (a[e] = [n]);
        var m = (n, d) => {
    ...
    (() => {
      ...
      var n = (n, d) => {
          ...
          for (n && n(d); f < i.length; f++)
            (o = i[f]), b.o(e, o) && e[o] && e[o][0](), (e[o] = 0);
          return b.O(t);
        },
        d = (self.webpackChunkembed_iframe =
          self.webpackChunkembed_iframe || []);
